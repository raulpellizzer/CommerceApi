...
class DatabaseConnector
{
     ...
     * CommerceApi db is responsible for authentication and user database name.
     * $database is the database name to connect to the user's database.
     * First connection is to the auth database (CommerceApi) to check user authentication. Once authenticated, the database name is retrieved for the given auth user.
