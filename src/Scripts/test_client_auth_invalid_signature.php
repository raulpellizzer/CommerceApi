<?php
/**
 * Test Client Authentication - Invalid Signature
...
echo "============================================\n";
echo "Testing Client Authentication - INVALID Signature\n";
echo "============================================\n\n";
...
$correctSignature = hash_hmac('sha256', $message, $apiSecret);

// Use WRONG signature
$wrongSignature = hash_hmac('sha256', 'WRONG_MESSAGE', $apiSecret);

echo "Correct Signature: {$correctSignature}\n";
echo "Sending Wrong:     {$wrongSignature}\n\n";
...
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    'X-API-Key: ' . $apiKey,
    'X-Signature: ' . $wrongSignature,  // WRONG!
